	...
	if (HOUSEHOLD_BALANCE_SHEET_CALENDAR.stocks.main_residence.mortgage.active)
	{
			...
			&& HOUSEHOLD_BALANCE_SHEET_CALENDAR.stocks.main_residence.mortgage.arrears_counter < MAX_DURATION_MORTGAGE_LOANS_ARREARS)
		{
			if ( reservation_hmr <= budget_remaining+ 1e-5)
			{
				...
				{
					fprintf(stderr, "\n\t In %s:%s(), line %d: HOUSEHOLD_BALANCE_SHEET_CALENDAR.stocks.main_residence.mortgage.outstanding_principal = %f\n", __FILE__, __FUNCTION__, __LINE__, HOUSEHOLD_BALANCE_SHEET_CALENDAR.stocks.main_residence.mortgage.outstanding_principal);
					HOUSEHOLD_BALANCE_SHEET_CALENDAR.stocks.main_residence.mortgage.outstanding_principal = 0.0;
				}

				assert__(HOUSEHOLD_BALANCE_SHEET_CALENDAR.stocks.main_residence.mortgage.outstanding_interest>-1e-3)
				{
					fprintf(stderr, "\n\t In %s:%s(), line %d: HOUSEHOLD_BALANCE_SHEET_CALENDAR.stocks.main_residence.mortgage.outstanding_interest = %f\n", __FILE__, __FUNCTION__, __LINE__, HOUSEHOLD_BALANCE_SHEET_CALENDAR.stocks.main_residence.mortgage.outstanding_interest);
					HOUSEHOLD_BALANCE_SHEET_CALENDAR.stocks.main_residence.mortgage.outstanding_interest = 0.0;
				}
			}
			else
			{
		...
		{
			assert__(HOUSEHOLD_BALANCE_SHEET_CALENDAR.stocks.main_residence.mortgage.outstanding_principal < 0.00001)
			{
				fprintf(stderr, "\n\t In %s:%s(), line %d: HOUSEHOLD_BALANCE_SHEET_CALENDAR.stocks.main_residence.mortgage.outstanding_principal = %f\n", __FILE__, __FUNCTION__, __LINE__, HOUSEHOLD_BALANCE_SHEET_CALENDAR.stocks.main_residence.mortgage.outstanding_principal);
				HOUSEHOLD_BALANCE_SHEET_CALENDAR.stocks.main_residence.mortgage.outstanding_principal = 0.0;
			}
...
*/
    ...
    */
		...
		for (j=0; j<list.size; j++) 
		{
			...
			assert__(HOUSEHOLD_BALANCE_SHEET_CALENDAR.stocks.rental_property_list.array[i].mortgage.outstanding_principal>-0.00001)
			{
				fprintf(stderr, "\n\t In %s:%s(), line %d: HOUSEHOLD_BALANCE_SHEET_CALENDAR.stocks.rental_property_list.array[i].mortgage.outstanding_principal=%f\n", __FILE__, __FUNCTION__, __LINE__, HOUSEHOLD_BALANCE_SHEET_CALENDAR.stocks.rental_property_list.array[i].mortgage.outstanding_principal);
				HOUSEHOLD_BALANCE_SHEET_CALENDAR.stocks.rental_property_list.array[i].mortgage.outstanding_principal = 0.0;
			}

			assert__(HOUSEHOLD_BALANCE_SHEET_CALENDAR.stocks.rental_property_list.array[i].mortgage.outstanding_interest>-0.00001)
			{
				fprintf(stderr, "\n\t In %s:%s(), line %d: HOUSEHOLD_BALANCE_SHEET_CALENDAR.stocks.rental_property_list.array[i].mortgage.outstanding_interest=%f\n", __FILE__, __FUNCTION__, __LINE__, HOUSEHOLD_BALANCE_SHEET_CALENDAR.stocks.rental_property_list.array[i].mortgage.outstanding_interest);
				HOUSEHOLD_BALANCE_SHEET_CALENDAR.stocks.rental_property_list.array[i].mortgage.outstanding_interest = 0.0;
			}
